...
pygame.display.set_caption("Maze Builder by Adithya")
                ...
                if current_cell.destination:
                    ...
                    while current_cell != source_cell:
                        ...
                        if current_cell:
                            ...
                            pygame.draw.rect(win, YELLOW if not current_cell.destination == True else BLUE, (current_cell.x * TILE + THICKNESS, current_cell.y * TILE + THICKNESS, TILE - THICKNESS, TILE - THICKNESS))
                    ...
                    next_cell.parent_cell = current_cell
                    current_cell = next_cell
                else:
